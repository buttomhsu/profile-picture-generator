...
$(window).konami({
  ...
  cheat: function() {
    ...
    $('.preview').animate({'top':'-1200px','opacity':'0.5'},3000).animate({'width':'0','opacity':'0'},3000,function(){
      $('#content').slideUp();
    })
  }
});
...
function createImage(template,source,x,y,w,h){
  ...
  resize_canvas.width = 1200;
  resize_canvas.height = 628;

  var ctx = resize_canvas.getContext("2d");
  ctx.rect(0,0,1200,628);
  ctx.fillStyle="#CCCCCC";
  ctx.fill();
  ctx.drawImage(userimage,x,y,w,h);
  ctx.drawImage(cover,0,0,1200,628);
